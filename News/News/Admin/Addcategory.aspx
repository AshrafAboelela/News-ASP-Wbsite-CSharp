<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminmaster.Master" AutoEventWireup="true" 
    CodeBehind="Addcategory.aspx.cs" Inherits="News.Admin.Addcategory" %>
...
<div class="login-popup-sec" >
  <div class="login-content">
    ...
    <h2>إضافة فئة أخبار</h2>
<table>
					<tr>
					<td><asp:Label ID="Label1" runat="server" Text="إسم فئة الأخبار" Font-Size="25px" 
                        ForeColor="#0066FF"></asp:Label></td>                     				
					<td><asp:TextBox ID="txt_categoryname" class="inpt" runat="server"></asp:TextBox>
                      <asp:Label ID="lbl_categoryname" runat="server" Text="مطلوب" Font-Size="15px" 
                          ForeColor="Red" Visible="False"/></td>
                         <td style="height: 25px;"></td>                                                
                    <td><asp:Button ID="btn_save_category" class="login-btn" runat="server" Text="حفظ فئة أخبار"
                         OnClick="btn_save_category_Click" /></td>
					</tr>
					</table>
      </form>     
  </div>
