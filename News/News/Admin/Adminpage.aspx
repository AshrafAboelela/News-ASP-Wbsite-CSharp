<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/adminmaster.Master" AutoEventWireup="true" 
    CodeBehind="Adminpage.aspx.cs" Inherits="News.Admin.Adminpage" %>
...
<h2>فئات الأخبار</h2>
					<table>
					<tr>
					<td><img src="../Images/addcategory.png" alt="Img"></td>
					<td><a href="../Admin/Addcategory.aspx">إضافة فئة</a></td>
...
<h2>الأخبار</h2>
					<table>
					<tr>
					<td><img src="../Images/addnew.png" alt="Img"></td>
					<td><a href="../Admin/addnews.aspx">إضافة خبر</a></td>
					<td><img src="../Images/news.png" alt="Img"></td>
					<td><a href="../Admin/shownews.aspx">عرض الأخبار</a></td>
					</tr>
					</table>
					</div>
				</div>
...
<div class="login-popup-sec" >
  <div class="login-content">
					...
					<table>
					<tr>
					<td><img src="../Images/adduser.png" alt="Img"></td>
					<td><a href="../Admin/addusers.aspx">إضافة مستخدم</a></td>
